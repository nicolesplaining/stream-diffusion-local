...
class Engine:
    ...
    def build(
        ...
        # Raw TensorRT build path. polygraphy's CreateConfig/engine_from_network
        # wrappers are incompatible with TensorRT 11.x (CUDA 13 / Blackwell): the
        # FP16 BuilderFlag was removed in favour of strongly-typed networks.
